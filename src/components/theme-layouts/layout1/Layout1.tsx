	...
	return (
		...
		>
			...
			<div className="flex min-w-0 flex-auto">
				{isLoginAndApprove && <NavbarWrapperLayout1 />}

				<main
					id="fuse-main"
					className="relative z-10 flex min-h-full min-w-0 flex-auto flex-col"
				>
					{(isLoginAndApprove  || isLogin) && (
						<ToolbarLayout1 isApproved={isLoginAndApprove} className={config.toolbar.style === 'fixed' ? 'sticky top-0' : ''} />
					)}
